      ...
      <div className="p-4">
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-irctc-blue/30 focus:border-irctc-blue"
          />
        </div>
            ...
            <div className="divide-y divide-gray-50">
              {results.map((station) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-3 py-3 hover:bg-irctc-blue-light/50 transition-colors text-left rounded-lg ${
                    selectedStation?.code === station.code ? 'bg-irctc-blue-light' : ''
                  }`}
                >
                  <div className="w-8 h-8 rounded-lg bg-irctc-blue-light flex items-center justify-center shrink-0">
