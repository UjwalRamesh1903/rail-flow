...
export const trains: Train[] = [
  ...
  {
    id: 't21', number: '12002', name: 'New Delhi Shatabdi Express', type: 'Shatabdi',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Bhopal Junction', toCode: 'BPL',
    departure: '06:00', arrival: '14:25', duration: '8h 25m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(0.9).filter((c) => ['CC', 'EC', '2S'].includes(c.code)),
  ...
  {
    id: 't22', number: '12017', name: 'Kalka Shatabdi Express', type: 'Shatabdi',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Kalka', toCode: 'KLK',
    departure: '07:40', arrival: '11:45', duration: '4h 05m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(0.85).filter((c) => ['CC', 'EC'].includes(c.code)),
  },
  {
    id: 't23', number: '12303', name: 'Poorva Express', type: 'Express',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Howrah Junction', toCode: 'HWH',
    departure: '19:40', arrival: '17:15', duration: '21h 35m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(0.95),
  },
  {
    id: 't24', number: '12431', name: 'Rajdhani Express', type: 'Rajdhani',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Thiruvananthapuram Central', toCode: 'TVC',
    departure: '11:00', arrival: '05:00', duration: '42h 00m',
    runningDays: ['Mon', 'Thu'],
    classes: makeClasses(1.3),
  ...
  {
    id: 't25', number: '12615', name: 'Grand Trunk Express', type: 'Express',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Chennai Central', toCode: 'MAS',
    departure: '18:40', arrival: '04:45', duration: '34h 05m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(1.0),
  },
  {
    id: 't26', number: '12779', name: 'Goa Express', type: 'Express',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Vasco da Gama', toCode: 'VSG',
    departure: '15:00', arrival: '14:30', duration: '35h 30m',
    runningDays: ['Mon', 'Wed', 'Fri', 'Sun'],
    classes: makeClasses(1.05),
  },
  {
    id: 't27', number: '12434', name: 'Jammu Rajdhani Express', type: 'Rajdhani',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Jammu Tawi', toCode: 'JAT',
    departure: '22:45', arrival: '07:15', duration: '8h 30m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(1.1),
  },
  {
    id: 't28', number: '11057', name: 'Mumbai Mail', type: 'Mail',
    from: 'New Delhi', fromCode: 'NDLS', to: 'Mumbai Central', toCode: 'MMCT',
    departure: '21:05', arrival: '18:30', duration: '21h 25m',
    runningDays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    classes: makeClasses(0.9),
  },
]
