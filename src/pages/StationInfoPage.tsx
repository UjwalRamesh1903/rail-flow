...
export function StationInfoPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Station Information</h1>
      <p className="text-sm text-gray-500 mb-6">Search stations by name, code, or city.</p>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-irctc-blue/30"
        />
      </div>

      <div className="bg-white rounded-2xl border border-gray-100 divide-y">
        {results.length === 0 ? (
          <div className="p-8 text-center text-gray-500">No stations found.</div>
        ) : (
          results.map((station) => (
