...
export function TravelInfoPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Travel Information</h1>
      <p className="text-sm text-gray-500 mb-8">Everything you need to know for a comfortable train journey.</p>
