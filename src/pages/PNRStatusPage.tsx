...
export function PNRStatusPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">PNR Status Enquiry</h1>
      <p className="text-sm text-gray-500 mb-6">Enter your 10-digit PNR number to check booking status.</p>
      ...
      <form onSubmit={handleSearch} className="bg-white rounded-2xl border border-gray-100 p-5 mb-6">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-irctc-blue/30"
            maxLength={10}
          />
      ...
      {result && (
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden animate-slide-up">
